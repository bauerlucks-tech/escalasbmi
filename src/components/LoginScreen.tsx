...
import { HelicopterIcon, PlatformIcon, WaveIcon } from '@/components/icons/OffshoreIcons';
    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 opacity-10">
          <HelicopterIcon className="w-32 h-32 text-primary animate-float" />
        </div>
        <div className="absolute bottom-20 right-10 opacity-10">
          <PlatformIcon className="w-40 h-40 text-secondary" />
        </div>
        <div className="absolute bottom-0 left-0 right-0 opacity-20">
          <WaveIcon className="w-full h-24 text-secondary" />
        </div>
      </div>
      ...
      <div className="glass-card-elevated w-full max-w-md p-8 animate-slide-up relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gradient mb-2">Escala Offshore</h1>
