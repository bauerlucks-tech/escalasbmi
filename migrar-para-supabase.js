// SCRIPT DE MIGRAÇÃO - LOCALSTORAGE PARA SUPABASE
          ...
          for (const swap of swaps) {
            try {
              await supabase.from('swap_requests').insert({
                requester_id: null, // Será preenchido depois
                target_id: null,    // Será preenchido depois
          ...
          for (const vacation of vacationData.requests) {
            try {
              await supabase.from('vacation_requests').insert({
                operator_id: null, // Será preenchido depois
