...
async function createAdminUser() {
  console.log('🔧 CRIANDO USUÁRIO ADMIN COM SENHA VÁLIDA');
  console.log('='.repeat(60));
  
  // Email e senha válidos (mínimo 6 caracteres)
  const email = 'admin@escalasbmi.com';
  const password = '123456'; // 6 caracteres
...
async function main() {
  console.log('🔧 SOLUÇÃO DEFINITIVA - SENHA 123456');
  console.log('='.repeat(60));
  ...
  if (result) {
    ...
    console.log('2. Email: admin@escalasbmi.com');
