...
async function createAdminUser() {
  console.log('🔧 CRIANDO USUÁRIO ADMIN - SENHA 123asd');
  console.log('='.repeat(60));
  
  // Email e senha solicitados
...
async function main() {
  console.log('🔧 CRIAÇÃO DO ADMIN - SENHA 123asd');
  console.log('='.repeat(60));
  ...
  if (result) {
    ...
    if (result.needsConfirmation) {
      ...
      console.log('🎯 SENHA DEFINITIVA: 123asd');
    }
    
  } else {
    console.log('\n❌ FALHA NA OPERAÇÃO');
    console.log('💡 Tente novamente mais tarde ou manualmente');
  }
}
